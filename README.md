...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-dawn-dd02
```

A live public deployment of this template is available at [https://damp-dawn-dd02.templates.workers.dev](https://damp-dawn-dd02.templates.workers.dev)
